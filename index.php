...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>I'm a passionate <span><?=$data['title']?></span> <?=$data['place']?></h2>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/lee.jpg" class="img-fluid" alt="">
        </div>
       ...
       while($row = $counter_result -> fetch_assoc()){
         ?>
           <div class="col-lg-3 col-md-6">
             <div class="count-box">
               <i class="<?=$row['icon']?>"></i>
               <span data-purecounter-start="0" data-purecounter-end="<?=$row['post']?>" data-purecounter-duration="1" class="purecounter"></span>
               <p><?=$row['title']?></p>
             </div>
           </div>
         <?php
        ...
        if ($skills_result && mysqli_num_rows($skills_result) > 0) {
          while ($row = mysqli_fetch_assoc($skills_result)) {
            if ($count % 3 == 0 && $count > 0) {
              echo '</div></div><div class="col-lg-6"><div class="row">';
            }
            ?>
            <div class="col-lg-4 col-md-6 mt-4">
              <div class="icon-box">
                <i class="<?php echo $row['icon']; ?>" style="color: <?php echo $row['color']; ?>"></i>
      ...
      <div class="row">
        ...
        if ($skills_result && mysqli_num_rows($skills_result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($skills_result)) {
            ...
            <div class="col-lg-4 col-md-6 mt-4">
              <div class="progress">
                <span class="skill"><i class="val"><?php echo $row['percentage']; ?>%</i></span>
                <div class="progress-bar-wrap">
                  <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $row['percentage']; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </div>
            <?php
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4><?=$data['name']?></h4>
            <p><em>Motivated and skilled software developer with experience in web development and programming. Excited to leverage skills and knowledge to contribute to the development of innovative software products.</em></p>
            <p>
            <ul>
              <li><?=$data['city']?></li>
              <li><?=$data['phone']?></li>
          ...
          <div class="resume-item">
            ...
            <h5>2020 - 2023</h5>
            <p><em>Zetech University, Ruiru, Kenya</em></p>
            <p>The beautiful thing about learning is that no on can take it away from you.</p>
          </div>
          <div class="resume-item">
            <h4>Secondary Education</h4>
            <h5>2016 - 2019</h5>
            <p><em> Ontulili Boys High School, Nanyuki, Kenya</em></p>
          ...
          <div class="resume-item">
            ...
            <h5>2004 - 2015</h5>
            <p><em> St. Paul’s Primary School, Meru, Kenya</em></p>
